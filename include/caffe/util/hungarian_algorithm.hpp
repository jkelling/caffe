///////////////////////////////////////////////////////////////////////////////
// hungarian_algorithm.hpp: Header file for Class HungarianAlgorithm.
//
...
#ifndef CAFFE_HUNGARIAN_H
#define CAFFE_HUNGARIAN_H
...
private:
  ...
  void computeassignmentcost(
      int *assignment, double *cost, double *distMatrix, int nOfRows);
  void step2a(
      int *assignment, double *distMatrix, bool *starMatrix,
